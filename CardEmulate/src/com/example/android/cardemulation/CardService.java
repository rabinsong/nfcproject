...
public class CardService extends HostApduService {
    ...
    private static final String SAMPLE_LOYALTY_CARD_AID = "1111111111111111";
    ...
    public byte[] processCommandApdu(byte[] commandApdu, Bundle extras) {
        ...
        if (Arrays.equals(SELECT_APDU, commandApdu)) {
			...
			//
            return ConcatArrays(HexStringToByteArray(SAMPLE_LOYALTY_CARD_AID), accountBytes, SELECT_OK_SW);
        } else {
